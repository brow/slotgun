...
describe('parser', function(){
  ...
  describe('.parseHostLine', function(){
    ...
    it('returns the name of the host', function(){
      assert.deepEqual(
    ...
    it('parses even if the trailing comma is missing', function(){
      assert.deepEqual(
  ...
  describe('.parseEventLine', function(){
    ...
    it('returns a partial event object', function(){
      assert.deepEqual(
    ...
    it('parses even if date is followed by a comma', function(){
      assert.deepEqual(
  ...
  describe('.parseEmailBody', function(){
    ...
    it('returns no events for an empty string', function(){
      assert.deepEqual(parser.parseEmailBody(""), []);
    })

    it('returns no events if no hosts are included', function(){
      assert.deepEqual(parser.parseEmailBody(readTestFile('event_no_host.txt')), []);
    });

    it('parses a single event for a single host', function(){
